...
namespace GuideMe.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public ActionResult CreateRole(RoleViewModel role)
        {
            ...
            {
                IdentityResult Result = RoleManager.Create(new IdentityRole(role.Name));
        ...
        public ActionResult AddUserToRole()
        {
            ...
            ViewData["Users"] = new SelectList(UserManager.Users.ToList(),"Id", "UserName");
            return View();
        }
        ...
        {
            IdentityResult result =  UserManager.AddToRole(userId, role);
            if (result.Succeeded)
                return RedirectToAction("Index", "Home");
            else
                return View();
